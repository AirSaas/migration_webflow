...
**Date** : 2026-04-28T12:17:48.507Z

**Total** : 88 pages — **81 PASS** / 6 FAIL / 1 SKIP
...
|---|---|---|---|---|---|---|
| `automatiser-la-com-projet` | produit | 13% | 8 | 2 | vous n'entendrez bientôt plus ces phrases ...<br/>a joutez les sponsors sur vos projets<br/>un récap' complet et synthétique<br/>tendance des projets vitaux<br/>tendance de leurs projets à eux |  |
...
| `traduction-one-click-avec-deepl` | produit | 13% | 8 | 5 | vos chefs de projets et po ‍ vont adorer<br/>p lateforme multilingue à la maille utilisateur<br/>é crivez dans votre langue maternelle , on s'occup<br/>a nimer une réunion, aligner les parties prenantes<br/>une autre langue vous changerait la vie ? |  |
| `flash-report-projet` | solution | 24% | 21 | 18 | l’outil de flash report projet favori des dsi et p<br/>consolidez toutes vos données en un seul clic<br/>vo tre flash report 100% automatisé<br/>de s intégrations natives pour éviter le report de<br/>personnalisez votre reporting projet |  |
...
| `jalon-projet` | blog | 67% | 9 | 11 | trouver le bon nombre de jalons ‍<br/>penser à assortir une échéance pour chaque jalon ‍<br/>des exemples de choix de jalons ‍ |  |

## All pages (sorted by coverage)

| Slug | Type | Status | Cov H | Live/Rebuild H | Live/Rebuild p | Live/Rebuild fig |
|---|---|---|---|---|---|---|
| `portfolio-management` | solution | SKIP | — | —/— | —/— | —/— |
| `automatiser-la-com-projet` | produit | FAIL | 13% | 8/2 | 30/2 | 0/0 |
| `traduction-one-click-avec-deepl` | produit | FAIL | 13% | 8/5 | 28/8 | 0/0 |
| `revue-de-portefeuille` | solution | FAIL | 16% | 19/17 | 49/17 | 0/0 |
| `priorisation-par-equipes` | produit | FAIL | 20% | 10/6 | 27/9 | 0/0 |
| `flash-report-projet` | solution | FAIL | 24% | 21/18 | 49/19 | 0/0 |
| `capacity-planning` | lp | PASS | 25% | 40/11 | 80/13 | 0/0 |
| `ppm` | lp | PASS | 26% | 35/10 | 74/13 | 0/0 |
| `reporting-projet` | produit | PASS | 27% | 11/7 | 29/12 | 0/0 |
| `capacity-planning` | produit | PASS | 29% | 17/10 | 39/22 | 0/0 |
| `management-de-portefeuille-projet` | solution | PASS | 30% | 23/20 | 54/21 | 0/0 |
| `pmo` | lp | PASS | 31% | 36/12 | 83/14 | 0/0 |
| `tableau-de-bord-portefeuille-de-projet` | solution | PASS | 36% | 22/19 | 50/20 | 0/0 |
| `pi-planning` | lp | PASS | 38% | 29/12 | 80/16 | 0/0 |
| `flash-report` | solution | PASS | 44% | 16/15 | 46/16 | 0/0 |
| `airsaas-et-les-experts-de-la-transfo` | solution | PASS | 50% | 6/5 | 41/4 | 0/0 |
| `budget` | produit | PASS | 53% | 15/9 | 33/11 | 0/0 |
| `outil-pmo` | equipe | PASS | 55% | 20/13 | 67/16 | 0/0 |
| `it-et-operation` | equipe | PASS | 56% | 18/10 | 60/12 | 0/0 |
| `comite-direction` | equipe | PASS | 62% | 13/9 | 51/10 | 0/0 |
| `tableau-de-bord-gestion-de-projet` | solution | PASS | 64% | 14/10 | 39/25 | 0/0 |
| `jalon-projet` | blog | FAIL | 67% | 9/11 | 47/35 | 5/5 |
| `outil-ppm` | solution | PASS | 68% | 37/26 | 68/51 | 0/0 |
| `direction-de-la-transformation` | equipe | PASS | 69% | 16/11 | 52/15 | 0/0 |
| `tableau-de-bord-dsi` | solution | PASS | 82% | 22/19 | 57/35 | 0/0 |
| `outils-de-pilotage-projet` | solution | PASS | 83% | 30/27 | 83/57 | 0/0 |
| `gestion-portefeuille-projet` | solution | PASS | 85% | 34/31 | 79/56 | 0/0 |
| `appel-doffres-et-evaluation-dune-solution-ppm-project-portfolio-management` | blog | PASS | 90% | 10/12 | 83/69 | 3/3 |
| `demarche-de-projet` | blog | PASS | 90% | 20/22 | 50/37 | 4/4 |
| `comment-mettre-une-bonne-meteo-projet` | blog | PASS | 92% | 24/26 | 64/57 | 10/10 |
...
| `plan-capacitaire` | blog | PASS | 100% | 16/18 | 82/65 | 3/0 |
| `plan-de-communication-projet` | blog | PASS | 100% | 21/23 | 84/69 | 9/8 |
| `planification-de-la-capacite` | blog | PASS | 100% | 13/15 | 73/56 | 1/0 |
| `planification-de-la-demande-capacity-planning` | blog | PASS | 100% | 8/10 | 58/41 | 4/0 |
| `pourquoi-mettre-en-place-un-pmo` | blog | PASS | 100% | 10/12 | 66/57 | 8/8 |
| `preparer-comite-de-pilotage-d-un-projet` | blog | PASS | 100% | 19/20 | 61/44 | 11/0 |
| `pourquoi-vos-18-millions` | blog | PASS | 100% | 8/11 | 91/64 | 2/0 |
| `portefeuille-projet` | blog | PASS | 100% | 51/53 | 109/92 | 6/8 |
| `reporting-pmo` | blog | PASS | 100% | 21/23 | 76/59 | 8/0 |
| `program-increment-planning` | blog | PASS | 100% | 26/29 | 161/117 | 0/0 |
| `role-du-pmo` | blog | PASS | 100% | 15/17 | 67/56 | 6/6 |
| `retour-sur-agile-en-seine-2023` | blog | PASS | 100% | 25/27 | 131/131 | 19/17 |
| `tout-savoir-sur-la-note-de-cadrage-projet` | blog | PASS | 100% | 16/18 | 68/58 | 7/7 |
| `trois-innovations-et-tendances-qui-bousculent-la-gestion-de-portefeuille-de-projets` | blog | PASS | 100% | 12/14 | 83/70 | 6/6 |
