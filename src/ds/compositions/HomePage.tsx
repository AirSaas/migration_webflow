...
const faqItems = [
  ...
  { question: "Comment gérer des compétences différentes dans une équipe ?", answer: "AirSaas vous permet de définir des profils de compétences par équipe et de visualiser la disponibilité par compétence." },
...
export default function HomePage() {
  return (
    <div className="w-full">
      <Hero navItems={navItems} navCtaLabel="Demander une démo" navCtaHref="#" loginLabel="Login" loginHref="#" topTag={{ label: "Capacity Planning simplifié", variant: "muted" }} headline="Vos équipes sont surchargées ? C'est normal :" headlineGradient="personne ne sait ce qu'elles peuvent vraiment faire." subtitle='AirSaas vous donne une vue capacitaire claire et actionnable. Enfin un outil pour dire "non" avec des données, pas au feeling.' bottomTags={[{ label: "Opérationnel en 1 mois", variant: "success" }, { label: "Accompagnement premium inclus", variant: "success" }]} primaryCta={{ label: "Réservez une démo", href: "#" }} secondaryCta={{ label: "Découvrir l'outil PPM en vidéo (5 min)", href: "#" }} illustrationSrc="https://placehold.co/1457x857/e8eafc/3a51e2?text=Product+Screenshot" illustrationAlt="AirSaas product screenshot" />

      <AnimateOnScroll animation="fade" duration={500}><LogosBar logos={logos} /></AnimateOnScroll>

      <AnimateOnScroll animation="fade-up" duration={700}>
        <ValuePropositionFrame variant="light" tag="Capacity Planning & Gouvernance de portefeuille" titleHighlight="Les chiffres" title="qui vous feront adopter AirSaas" subtitle="Un déploiement simple et accompagné, pas un projet IT de 6 mois.">
      ...
      <AnimateOnScroll animation="fade-up" duration={700}>
        <ComparisonFrame title="Les vrais problèmes du capacity planning" subtitle="Un déploiement simple et accompagné, pas un projet IT de 6 mois." items={[
      ...
      <AnimateOnScroll animation="fade-right" duration={800}><FeatureFrame imagePosition="right" tag="Intelligence Artificielle" titleHighlight="Agent IA" title="Brief projet" description='Quand une demande arrive floue, l&apos;agent IA mène l&apos;entretien et transforme chaque demande en brief clair.' checklist={["Entretien guidé par l'IA", "Brief structuré automatiquement", "Comparaison objective des demandes", "Intégration native avec vos outils"]} ctaLabel="Découvrir" imageSrc="https://placehold.co/1125x696/e8eafc/3a51e2?text=Agent+IA" /></AnimateOnScroll>

      <AnimateOnScroll animation="fade-left" duration={800}><FeatureFrame imagePosition="left" tag="Capacity Planning" titleHighlight="Vue capacitaire" title="en temps réel" description="Visualisez instantanément la charge de vos équipes, identifiez les surcharges et anticipez les conflits de ressources." checklist={["Vision macro des capacités", "Alertes automatiques de surcharge", "Simulation de scénarios", "Export pour le COMEX"]} ctaLabel="En savoir plus" imageSrc="https://placehold.co/1125x731/fffbeb/e58d05?text=Capacity+Planning" imageBgColor="#fffbeb" /></AnimateOnScroll>
      ...
      <AnimateOnScroll animation="fade-right" duration={800}><FeatureFrame imagePosition="right" tag="Roadmap" titleHighlight="Roadmap" title="collaborative" description="Partagez une roadmap unique entre toutes les parties prenantes." checklist={["Roadmap partagée", "Mises à jour en temps réel", "Notifications automatiques", "Vue timeline"]} ctaLabel="Découvrir la roadmap" imageSrc="https://placehold.co/1125x696/e8eafc/3a51e2?text=Roadmap" /></AnimateOnScroll>

      <AnimateOnScroll animation="fade-left" duration={800}><FeatureFrame imagePosition="left" tag="Reporting" titleHighlight="Flash report" title="automatisé" description="Générez des rapports flash en un clic pour vos comités de pilotage." checklist={["Rapport en 1 clic", "Données consolidées", "Format COMEX-ready", "Historique complet"]} ctaLabel="Voir un exemple" imageSrc="https://placehold.co/1125x731/fffbeb/e58d05?text=Flash+Report" imageBgColor="#fffbeb" /></AnimateOnScroll>

      <AnimateOnScroll animation="fade-right" duration={800}><FeatureFrame imagePosition="right" tag="Priorisation" titleHighlight="Scoring" title="intelligent" description="Évaluez et comparez vos projets avec un scoring objectif." checklist={["Scoring multicritère", "Matrice de priorisation", "Alignement stratégique", "Décision data-driven"]} ctaLabel="En savoir plus" imageSrc="https://placehold.co/1125x696/e8eafc/3a51e2?text=Scoring" /></AnimateOnScroll>

      <AnimateOnScroll animation="fade-left" duration={800}><FeatureFrame imagePosition="left" tag="Gouvernance" titleHighlight="Pilotage" title="de portefeuille" description="Centralisez la gouvernance de votre portefeuille de projets." checklist={["Vue portefeuille 360°", "Suivi des jalons", "Gestion des risques", "Tableau de bord DSI"]} ctaLabel="Découvrir" imageSrc="https://placehold.co/1125x731/fffbeb/e58d05?text=Gouvernance" imageBgColor="#fffbeb" /></AnimateOnScroll>
      ...
      <AnimateOnScroll animation="fade-up" duration={700}><TestimonialsFrame title="Ils ont simplifié leur" titleHighlight="capacity planning" testimonials={testimonials} /></AnimateOnScroll>
      ...
      <AnimateOnScroll animation="fade-up" duration={700}>
        <ValuePropositionFrame variant="light" titleHighlight="Pourquoi" title="choisir AirSaas ?" subtitle="La plateforme conçue pour les PMO qui veulent enfin piloter, pas subir.">
          <FeatureCard icon={<Icon><CalendarDayIcon /></Icon>} title="Simple" description="Interface intuitive, adoption immédiate." className="flex-1" />
          ...
          <FeatureCard icon={<Icon><StopwatchIcon /></Icon>} title="Complet" description="Du capacity planning au flash report." className="flex-1" />
          <FeatureCard icon={<Icon><SuitcaseIcon /></Icon>} title="Accompagné" description="Une équipe dédiée à votre succès." className="flex-1" />
        </ValuePropositionFrame>
      </AnimateOnScroll>

      <AnimateOnScroll animation="fade-up" duration={600}><FaqFrame items={faqItems} /></AnimateOnScroll>

      <AnimateOnScroll animation="scale-up" duration={800}>
        <CtaFrame title="Arrêtez de lancer des projets sans capacité" subtitle="Découvrez comment AirSaas simplifie votre capacity planning.">
          ...
          <CardCta title="Découvrir le guide" description="Captez les gestes qui comptent." ctaLabel="Télécharger le guide" className="flex-1" />
        </CtaFrame>
      </AnimateOnScroll>

      <AnimateOnScroll animation="fade-up" duration={600}><Footer columns={footerColumns} /></AnimateOnScroll>
    </div>
  );
}
