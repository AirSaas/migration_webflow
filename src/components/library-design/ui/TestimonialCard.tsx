...
export function TestimonialCard({
  ...
  return (
    <article
      className={cn(
        "flex flex-col justify-between rounded-[1.25rem] md:rounded-[1.5625rem] border border-primary-10 bg-white transition-shadow duration-300 hover:shadow-card-hover",
        className
      )}
