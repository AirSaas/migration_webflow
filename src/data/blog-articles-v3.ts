...
export const BLOG_ARTICLES_V3: BlogArticleV3[] = [
  {
    ...
    "skip": false,
    "reason": "Applied all design rules: figures set to widthMode=breakout + tone=warm (fixing feedback from attempt 1), all H2/H3 headings mapped to DS level=3 with gradient=primary, TOC with 4 items triggers centeredToc layout, no quotes/callouts/tables/CTAs in this article. Preserved all paragraph and list content from extractor.",
    "meta": {
      "title": "Kanban & gestion de projet : la méthode pour optimiser votre suivi de projet",
      "description": "Découvrez comment utiliser concrètement le Kanban dans votre gestion de projet pour optimiser votre suivi de projet.",
  ...
  },
  {
    ...
    "skip": false,
    "reason": "Applied design rules: quotes→card, H2/H3→level 3 gradient primary, figures→breakout warm, TOC centered (6 items).",
    "meta": {
    ...
    "blocks": [
      ...
      {
        "type": "paragraph",
        "html": "En résumé : <strong>mettez en avant toute l'équipe de projet,</strong> notamment les équipes métiers.&nbsp;Sans oublier de rappeler les bénéfices clés pour les utilisateurs finaux - les clients de l'entreprise !"
      },
      {
        "type": "heading",
        "level": 3,
  ...
  },
  {
    "slug": "metier-pmo",
    "skip": false,
    "reason": "Applied designRules: every quote→card/left; alert blockquotes (isAlertCallout=true) converted to insight-callout with derived label/variant; H2 source→DS level=2 gradient primary; H3+ source→DS level=3 gradient primary (avoiding forbidden level=4 with gradient); table preserved; TOC has 9 items so layout=centeredToc; toggles copied from cmsToggles; FAQ items marked hidden=false. Table header styling is enforced by TableFrame DS component — feedback noted, contract spec is correct.",
    "meta": {
      ...
      "heroImage": {
        ...
        "alt": "PMO (Project Management Office) : le guide complet"
      },
      "author": {
        "name": "Jonas Roman",
        "category": "Gestion de projets",
    ...
    "blocks": [
      ...
      {
        "type": "insight-callout",
        "html": "Insight clé : les organisations plus petites bénéficient souvent davantage d'un PMO, car la culture s'enracine plus vite avant que les mauvaises habitudes ne se cristallisent.",
  ...
  },
  {
    "slug": "pi-planning",
    "skip": false,
    "reason": "Mapped 5 H2 + multiple H3 to DS level=3 gradient primary; H4 to level=4 none; all 14 quotes to card/left; converted first insight-callout (no emoji, generic) to primary 'À retenir'; HubSpot CTA at end converted to inline-cta /fr/meetings-pages. TOC has 5 items → centeredToc layout.",
    "meta": {
      "title": "PI Planning : le guide complet pour aligner vos équipes IT et métiers",
      "description": "Découvrez comment réussir votre PI Planning : définition, bénéfices, préparation, déroulement, outils et suivi post-événement pour aligner IT et métiers.",
  ...
  },
  {
    ...
    "skip": false,
    "reason": "Long pillar article on PPM. TOC has 9 items → centeredToc. All H2/H3 source headings mapped to DS level=3 with gradient primary. Figures set to breakout + warm. Alert blockquotes (⚠️/💡/📌/🎯/📊/🚀) with isAlertCallout=true converted to insight-callout with appropriate variants (warning for ⚠️, primary for others). Non-alert quotes (🏢 idée reçue, ⚡ bonne pratique) kept as Quote variant=card. Tables passed through (TableFrame renders white-on-primary headers via fixed DS). FAQ all visible. Related copied. Author and CTA toggles from CMS.",
    "meta": {
      "title": "Management de portefeuille de projet : définition, méthodes et outils",
      "description": "Gestion de portefeuille de projets (PPM) : définition, méthodes de priorisation, KPIs, outils et erreurs à éviter. Le guide complet pour DSI, PMO et directeurs de transformation.",
      ...
      "heroImage": {
        ...
        "alt": "Management de portefeuille de projet : définition, méthodes et outils"
      },
      "author": {
        "name": "Jérôme Dard",
        "category": "Gestion de projets",
    ...
    "blocks": [
      ...
      {
        "type": "quote",
        "text": "⚡ <strong>Bonne pratique AirSaaS :</strong> Les portefeuilles priorisés à 2-3 ans figés, c'était avant. Aujourd'hui, la priorisation en continu est la pratique courante. Un sondage AirSaas (2022) montre que la majorité des DSI repriorisent leur portefeuille au minimum chaque trimestre, et souvent chaque mois.",
        "variant": "card",
        "align": "left"
      },
      {
